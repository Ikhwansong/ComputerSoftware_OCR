...
from voc_data import create_batch_generator, create_batch_generator_with_customset
...
if __name__ == '__main__':
    ...
    batch_generator, val_generator, info = create_batch_generator_with_customset(
    ...
    try:
        ssd = create_ssd(NUM_CLASSES, args.arch,
                        ...
                        checkpoint_dir=args.checkpoint_dir, checkpoint_path = args.checkpoint_path)
